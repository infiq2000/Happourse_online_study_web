    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbar-collapse" role="navigation">
        <ul class="nav navbar-nav">
          <li class="nav-item">
            <a class="nav-link" href="https://github.com/fengyuanchen/cropperjs/blob/main/README.md" data-toggle="tooltip" title="View the documentation">Docs</a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link text-warning" href="https://fengyuanchen.github.io/cropperjs/v2/" data-toggle="tooltip" title="View the next version">v2.0 (Beta)</a>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="col-md-3 docs-toggles">
        ...
        <div class="dropdown dropup docs-options">
          ...
          <ul class="dropdown-menu" role="menu" aria-labelledby="toggleOptions">
        	...
        	<input id="data" name="hihihi" type="hidden" value="C:\Users\Tan Dat\git\Happourse\src\main\webapp\crop\note\cropped.png">
           <button onclick = "getCropped()">
            GetNote
            <span class="caret"></span>
          </button>
...
Click and paste here.
 ...
 function getCropped(){
	    ...
	    fetch('http://127.0.0.1:5000/test',{
	    	...
	    	$.ajax({
				  url: "/Happourse/GetCropped",
				  type: "post", //send it through get method
				  data: {
						base64image : data["greeting"] 
				  },
