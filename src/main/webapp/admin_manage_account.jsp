    	...
    	<div class="auto-container">
			...
			<div class="inner-container">
				<div class="container-content">
					...
					<div style="margin:40px 0 0 30%;">
						<form action="">
							<b>Add New Account</b></br>
							<input style="padding: 10px;border: solid;border-radius: 5px;width: 50%;" type="text" placeholder="Account1">
							<input style="padding: 10px;border: solid;border-radius: 5px;width: 50%; margin-top:20px;" type="password" placeholder="Account1">
							<input style="padding: 10px;border-radius: 5px;background: lightcoral;color: white;width: 8%;" type="submit" value="Add">
						</form>
					</div>
				</div>
			</div>
