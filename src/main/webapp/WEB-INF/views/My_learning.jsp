			...
			<header class="theme-menu-wrapper menu-style-one">
				<div class="container">
					<div class="header-wrapper clearfix">
						<!-- Logo -->
						<c:url var="tempLink" value="UserPage">
							<c:param name="uid" value="${uid}"></c:param>
	  					</c:url>
						<div class="logo float-left tran4s"><a href="${tempLink}"><img src="images/logo/logo.png" alt="Logo"></a></div>
								...
								<ul class="nav">
									...
									<li class="dropdown-holder menu-list" ><a class="tran3s"><span class="login">HI ${name}</span></a> 
										<ul class="sub-menu">
											...
											<li><a href="updatep_profile.jsp">Cập nhật thông tin</a></li>
											<li><a href="blog-list.html">Khóa học</a></li>
