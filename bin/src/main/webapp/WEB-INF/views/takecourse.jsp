						...
						<div class="col-lg-9 col-md-8 col-xs-12 all-product-wrapper shop-details float-right">
							<div class="single-product-details clearfix row">
								<div class="image col-lg-5 col-xs-12">
									...
									<ul>
										<li><img src="images/shop/14.jpg" alt=""></li>
										<li><img src="images/shop/15.jpg" alt=""></li>
										<li><img src="images/shop/16.jpg" alt=""></li>
									</ul>
								</div> <!-- /.image -->
								<div class="info col-lg-7 col-xs-12">
									<h3>Rcoket Luncher</h3>
									<strong>$14.70</strong>
									<ul class="rating">
									...
									<div class="clearfix">
										<div class="quantity float-left">
											<h6>Quantity</h6>
											<input type="number" placeholder="02" min="1">
										</div> <!-- /.quantity -->
										<div class="color-show float-left">
											<h6>Colors</h6>
											<ul>
												<li style="background:#3c4e87;"></li>
												<li style="background:#82d8cd;"></li>
												<li style="background:#f87b4f;"></li>
												<li style="background:#4293ef;"></li>
											</ul>
										</div>
									</div>
									<a href="#" class="add-cart tran3s">ADD TO CART</a>
